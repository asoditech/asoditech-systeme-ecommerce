...
const AUDIT_ACTION_META: Record<string, AuditActionMeta> = {
  ...
  "backup.drive_connected": { label: "Google Drive connecté", category: "parametres" },
  "backup.drive_disconnected": { label: "Google Drive déconnecté", category: "parametres" },
  "backup.drive_token_error": { label: "Jeton Google Drive expiré ou révoqué", category: "parametres" },
  "backup.drive_uploaded": { label: "Sauvegarde envoyée vers Google Drive", category: "parametres" },
  "backup.drive_downloaded": { label: "Sauvegarde téléchargée depuis Google Drive", category: "parametres" },
  "backup.drive_deleted": { label: "Sauvegarde Google Drive supprimée", category: "parametres" },
  "backup.drive_operation_failed": { label: "Échec d'une opération Google Drive", category: "parametres" },
  ...
  "commission.order_assigned": { label: "Agent de confirmation assigné à une commande", category: "finance" },
  "commission.earned": { label: "Commission de confirmation gagnée", category: "finance" },
  "commission.reversed": { label: "Commission de confirmation reprise", category: "finance" },
  "commission.statement_closed": { label: "Relevé de commissions clôturé", category: "finance" },
  "commission.statement_paid": { label: "Relevé de commissions payé", category: "finance" },
...
export const AUDIT_ENTITY_LABELS: Record<string, string> = {
  ...
  CommissionAgent: "Agent de confirmation",
  CommissionStatement: "Relevé de commissions",
  Expense: "Dépense",
